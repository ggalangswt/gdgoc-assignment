...
export default function NavbarDark() {
  ...
  return (
    <div
      className={`bg-[#23856D] flex items-center overflow-hidden transition-all duration-500 ease-in-out ${
        isVisible ? "h-[58px] opacity-100" : "h-0 opacity-0"
      }`}
    >
      <div className="w-full px-4 py-6 flex items-center gap-[30px] justify-between">
